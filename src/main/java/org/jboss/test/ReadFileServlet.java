...
/**
 * Servlet, which prints file content. By default it prints value of property
 * {@value #DEFAULT_FILE_NAME}, but you can specify another property name by
 * using request parameter {@value #PARAM_FILE_NAME}.
 * 
 * @author Josef Cacek
 */
