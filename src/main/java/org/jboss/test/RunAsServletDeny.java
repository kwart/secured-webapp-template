 ...
 * @author Josef Cacek
 */
@WebServlet(RunAsServletDeny.SERVLET_PATH)
@DeclareRoles({ HelloBean.AUTHORIZED_ROLE, HelloBean.NOT_AUTHZ_ROLE })
@RunAs(HelloBean.NOT_AUTHZ_ROLE)
public class RunAsServletDeny extends AbstractRunAsServlet {

    private static final long serialVersionUID = 1L;

    public static final String SERVLET_PATH = "/RunAsServletDeny";
