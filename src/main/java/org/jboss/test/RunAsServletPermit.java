 ...
 * @author Josef Cacek
 */
@WebServlet(RunAsServletPermit.SERVLET_PATH)
@DeclareRoles({ HelloBean.AUTHORIZED_ROLE, HelloBean.NOT_AUTHZ_ROLE })
@RunAs(HelloBean.AUTHORIZED_ROLE)
public class RunAsServletPermit extends AbstractRunAsServlet {

    private static final long serialVersionUID = 1L;

    public static final String SERVLET_PATH = "/RunAsServletPermit";
