 ...
 * @author Josef Cacek
 */
@WebServlet(urlPatterns = RunAsServletPermitLoadOnStartup.SERVLET_PATH, loadOnStartup = 1)
@DeclareRoles({ HelloBean.AUTHORIZED_ROLE, HelloBean.NOT_AUTHZ_ROLE })
@RunAs(HelloBean.AUTHORIZED_ROLE)
public class RunAsServletPermitLoadOnStartup extends AbstractRunAsServlet {

    private static final long serialVersionUID = 1L;

    public static final String SERVLET_PATH = "/RunAsServletPermitLoadOnStartup";
